//(f) Wind chill factor is the felt air temperature on exposed skin due to wind. 
...
//Write a program to receive values of t and v and calculate wind 
//chill factor (wcf).
...
printf("The Wind chill Temperature is : %.2f",wcf);
}